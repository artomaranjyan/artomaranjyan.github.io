...
<ol start="16" reversed>
  <li>
   ...
   Presenting
   <ul>
       <li><strong>MindFlayer: Efficient Asynchronous Parallel SGD in the Presence of Heterogeneous and Random Worker Compute Times (<span style="color: cyan;">Oral</span>) </strong></li>
